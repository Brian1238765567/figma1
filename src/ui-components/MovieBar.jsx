...
export default function MovieBar(props) {
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "MovieBar")}
    >
      <Flex
        gap="2px"
        direction="row"
      ...
      >
        ...
        <Text
          ...
          whiteSpace="pre-wrap"
          children="MoesMovies"
          {...getOverrideProps(overrides, "MoesMovies")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32130672772")}
      >
        <Text
          fontFamily="Inter"
          fontSize="16px"
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 32130672777")}
      >
        <Flex
          gap="4px"
          direction="column"
